...
Load the set of predictions for four mile square covering the New Orleans Spillway generated using a Random Forest classifier with training on the set of images in "pothole_training_image.tif" using the bands c(4,5,6). 
